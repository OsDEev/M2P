...
static int TObjLoadHost(HSD_TObj* tobj, HSD_TObjDesc* td)
{
    ...
    tobj->scale.x = td->scale.x;
    tobj->scale.y = td->scale.y;
    tobj->scale.z = td->scale.z;
    tobj->translate.x = td->translate.x;
    tobj->translate.y = td->translate.y;
    tobj->translate.z = td->translate.z;
