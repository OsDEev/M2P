                                        ...
                                        f32* prev_x, f32* prev_y, f32* prev_z)
{
    ...
    if (pp->kind & Trail) {
        ...
        if (it == NULL) {
            ...
            if (pp->kind & DispTexture) {
                GXTexCoord1x8((u8) (((pp->kind >> 16) & 0xC) + 1));
            }
            ...
            if (pp->kind & DispTexture) {
                GXTexCoord1x8((u8) (((pp->kind >> 16) & 0xC) + 2));
            }
            ...
            if (pp->kind & DispTexture) {
                GXTexCoord1x8((u8) (((pp->kind >> 16) & 0xC) + 3));
            }
        } else {
            ...
            if (up_len != 0.0f) {
                ...
                for (; primitive_count != 0; primitive_count--) {
                    ...
                    for (i = count; i > 0; i--) {
                        ...
                        GXPosition3f32(up.x * tx + (right.x * sx + x), up.y * tx + (right.y * sx + y), up_z * tx + (right_z * sx + z));
        ...
        if (pp->kind & DispTexture) {
            GXTexCoord1x8((u8) ((pp->kind >> 16) & 0xC));
        }
