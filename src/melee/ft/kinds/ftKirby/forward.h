...
#define ftKb_MF_MultiJump (Ft_MF_KeepGfx | Ft_MF_SkipHit | Ft_MF_SkipAnimVel | Ft_MF_Unk06)

#define ftKb_MF_AttackDash (Ft_MF_KeepFastFall | Ft_MF_KeepColAnimHitStatus | Ft_MF_SkipItemVis | Ft_MF_FreezeState)

#define ftKb_MF_AttackDashAir (ftKb_MF_AttackDash | Ft_MF_SkipParasol)

#define ftKb_MF_18_20_21 (Ft_MF_SkipItemVis | Ft_MF_UnkUpdatePhys | Ft_MF_FreezeState)

#define ftKb_MF_4_18_20_21 (ftKb_MF_18_20_21 | Ft_MF_SkipModel)

#define ftKb_MF_2_4_18_20_21 (ftKb_MF_4_18_20_21 | Ft_MF_KeepColAnimHitStatus)

#define ftKb_MF_5_18_20_21 (ftKb_MF_18_20_21 | Ft_MF_SkipAnimVel)

#define ftKb_MF_SpecialN (ftKb_MF_4_18_20_21 | Ft_MF_KeepFastFall)

#define ftKb_MF_SpecialS (ftKb_MF_4_18_20_21 | Ft_MF_KeepGfx)

#define ftKb_MF_SpecialHi (ftKb_MF_4_18_20_21 | Ft_MF_KeepFastFall | Ft_MF_KeepGfx)

#define ftKb_MF_SpecialNMr (ftKb_MF_4_18_20_21 | Ft_MF_KeepFastFall | Ft_MF_KeepColAnimHitStatus)

#define ftKb_MF_SpecialNKp (ftKb_MF_4_18_20_21 | Ft_MF_KeepFastFall | Ft_MF_SkipHit)

#define ftKb_MF_SpecialNPe (ftKb_MF_2_4_18_20_21 | Ft_MF_KeepFastFall | Ft_MF_SkipHit)

#define ftKb_MF_SpecialNYs (ftKb_MF_5_18_20_21 | Ft_MF_KeepFastFall)

#define ftKb_MF_SpecialNLg (ftKb_MF_5_18_20_21 | Ft_MF_KeepColAnimHitStatus)

#define ftKb_MF_SpecialNZd (ftKb_MF_5_18_20_21 | Ft_MF_KeepGfx | Ft_MF_KeepColAnimHitStatus)

#define ftKb_MF_SpecialNDr (ftKb_MF_5_18_20_21 | Ft_MF_SkipHit)

#define ftKb_MF_SpecialNGk (ftKb_MF_SpecialNZd | Ft_MF_SkipHit)

#define ftKb_MF_SpecialNFx (ftKb_MF_2_4_18_20_21 | Ft_MF_KeepGfx | Ft_MF_SkipThrowException)

#define ftKb_MF_SpecialNLk (ftKb_MF_4_18_20_21 | Ft_MF_KeepGfx | Ft_MF_SkipHit | Ft_MF_SkipThrowException)

#define ftKb_MF_SpecialNSk (ftKb_MF_SpecialNLk | Ft_MF_KeepFastFall)

#define ftKb_MF_SpecialNNs (ftKb_MF_2_4_18_20_21 | Ft_MF_SkipHit | Ft_MF_SkipThrowException)

#define ftKb_MF_SpecialNPp (ftKb_MF_SpecialNNs | Ft_MF_KeepGfx)

#define ftKb_MF_SpecialNPk (ftKb_MF_SpecialNPp | Ft_MF_KeepFastFall)

#define ftKb_MF_SpecialNSs (ftKb_MF_5_18_20_21 | Ft_MF_SkipThrowException)

#define ftKb_MF_SpecialNSs_1 (ftKb_MF_SpecialNSs | Ft_MF_KeepGfx)

#define ftKb_MF_SpecialNMt (ftKb_MF_SpecialNSs_1 | Ft_MF_KeepFastFall)

#define ftKb_MF_SpecialNCl (ftKb_MF_SpecialNMt | Ft_MF_KeepColAnimHitStatus)

#define ftKb_MF_SpecialNFc (ftKb_MF_SpecialNDr | Ft_MF_KeepFastFall | Ft_MF_SkipThrowException)

#define ftKb_MF_SpecialNPc (ftKb_MF_SpecialNSs_1 | Ft_MF_SkipHit)

#define ftKb_MF_SpecialNGw (ftKb_MF_SpecialNPc | Ft_MF_KeepFastFall)

#define ftKb_MF_SpecialLw (ftKb_MF_2_4_18_20_21 | Ft_MF_KeepSfx)

#define ftKb_MF_SpecialNCa (ftKb_MF_SpecialLw | Ft_MF_KeepFastFall | Ft_MF_KeepGfx)

#define ftKb_MF_SpecialNDk (ftKb_MF_4_18_20_21 | Ft_MF_SkipHit | Ft_MF_KeepSfx)

#define ftKb_MF_5_9_18_20_21 (ftKb_MF_5_18_20_21 | Ft_MF_KeepSfx)

#define ftKb_MF_2_5_9_18_20_21 (ftKb_MF_5_9_18_20_21 | Ft_MF_KeepColAnimHitStatus)

#define ftKb_MF_SpecialNPr (ftKb_MF_5_9_18_20_21 | Ft_MF_KeepGfx)

#define ftKb_MF_SpecialNMs (ftKb_MF_2_5_9_18_20_21 | Ft_MF_KeepFastFall)

#define ftKb_MF_SpecialNGn (ftKb_MF_2_5_9_18_20_21 | Ft_MF_SkipHit)

#define ftKb_MF_SpecialNFeStart (ftKb_MF_SpecialNMs | Ft_MF_SkipHit)

#define ftKb_MF_SpecialAirN (ftKb_MF_SpecialN | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirS (ftKb_MF_SpecialS | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirHi (ftKb_MF_SpecialHi | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNMr (ftKb_MF_SpecialNMr | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNKp (ftKb_MF_SpecialNKp | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNPe (ftKb_MF_SpecialNPe | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNYs (ftKb_MF_SpecialNYs | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNLg (ftKb_MF_SpecialNLg | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNZd (ftKb_MF_SpecialNZd | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNDr (ftKb_MF_SpecialNDr | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNGk (ftKb_MF_SpecialNGk | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNFx (ftKb_MF_SpecialNFx | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNLk (ftKb_MF_SpecialNLk | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNSk (ftKb_MF_SpecialNSk | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNNs (ftKb_MF_SpecialNNs | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNPp (ftKb_MF_SpecialNPp | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNPk (ftKb_MF_SpecialNPk | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNSs (ftKb_MF_SpecialNSs | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNMt (ftKb_MF_SpecialNMt | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNCl (ftKb_MF_SpecialNCl | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNFc (ftKb_MF_SpecialNFc | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNPc (ftKb_MF_SpecialNPc | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNGw (ftKb_MF_SpecialNGw | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirLw (ftKb_MF_SpecialLw | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNCa (ftKb_MF_SpecialNCa | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNDk (ftKb_MF_SpecialNDk | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNPr (ftKb_MF_SpecialNPr | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNMs (ftKb_MF_SpecialNMs | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNGn (ftKb_MF_SpecialNGn | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialNFe (ftKb_MF_SpecialNFeStart | Ft_MF_SkipParasol)

#define ftKb_MF_0_4_18_20_21 (ftKb_MF_4_18_20_21 | Ft_MF_KeepFastFall)

#define ftKb_MF_SpecialNCaptureTurn (ftKb_MF_0_4_18_20_21 | Ft_MF_KeepAccessory)

#define ftKb_MF_SpecialAirNCaptureTurn (ftKb_MF_SpecialNCaptureTurn | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialNCaptureWalk (ftKb_MF_0_4_18_20_21 | Ft_MF_UpdateCmd)

#define ftKb_MF_SpecialNCaptureJumpSquat (ftKb_MF_0_4_18_20_21 | Ft_MF_SkipNametagVis)

#define ftKb_MF_SpecialNLoop (ftKb_MF_0_4_18_20_21 | Ft_MF_Unk19)

#define ftKb_MF_SpecialNKpLoop (ftKb_MF_SpecialNKp | Ft_MF_Unk19)

#define ftKb_MF_SpecialNGkLoop (ftKb_MF_SpecialNGk | Ft_MF_Unk19)

#define ftKb_MF_SpecialNFxLoop (ftKb_MF_SpecialNFx | Ft_MF_Unk19)

#define ftKb_MF_SpecialNLkCharged (ftKb_MF_SpecialNLk | Ft_MF_Unk19)

#define ftKb_MF_SpecialNSkLoop (ftKb_MF_SpecialNSk | Ft_MF_Unk19)

#define ftKb_MF_SpecialNMtLoop (ftKb_MF_SpecialNMt | Ft_MF_Unk19)

#define ftKb_MF_SpecialNClCharged (ftKb_MF_SpecialNCl | Ft_MF_Unk19)

#define ftKb_MF_SpecialNFcLoop (ftKb_MF_SpecialNFc | Ft_MF_Unk19)

#define ftKb_MF_SpecialNPrLoop (ftKb_MF_SpecialNPr | Ft_MF_Unk19)

#define ftKb_MF_SpecialAirNLoop (ftKb_MF_SpecialNLoop | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNKpLoop (ftKb_MF_SpecialNKpLoop | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNGkLoop (ftKb_MF_SpecialNGkLoop | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNFxLoop (ftKb_MF_SpecialNFxLoop | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNLkCharged (ftKb_MF_SpecialNLkCharged | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNSkLoop (ftKb_MF_SpecialNSkLoop | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNMtLoop (ftKb_MF_SpecialNMtLoop | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNClCharged (ftKb_MF_SpecialNClCharged | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNFcLoop (ftKb_MF_SpecialNFcLoop | Ft_MF_SkipParasol)

#define ftKb_MF_SpecialAirNPrLoop (ftKb_MF_SpecialNPrLoop | Ft_MF_SkipParasol)
