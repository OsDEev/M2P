...
// Object-like macros (C2099: static initializers cannot reference the
// motion_flagsN statics above; motion_flags0 stays a static const).
#define motion_flags1 (motion_flags0 | Ft_MF_SkipMatAnim | Ft_MF_SkipColAnim)
#define motion_flags2                                                      \
    (motion_flags1 | Ft_MF_KeepGfx | Ft_MF_SkipModel | Ft_MF_SkipMatAnim | \
