 ...
 * melee/ft/forward.h. */
enum { ftSk_MF_Special =
    Ft_MF_SkipModel | Ft_MF_SkipItemVis | Ft_MF_UnkUpdatePhys |
    Ft_MF_FreezeState };

enum { ftSk_MF_SpecialS = ftSk_MF_Special | Ft_MF_KeepGfx };

enum { ftSk_MF_SpecialLw =
    ftSk_MF_Special | Ft_MF_KeepColAnimHitStatus };

enum { ftSk_MF_SpecialN =
    ftSk_MF_Special | Ft_MF_KeepFastFall | Ft_MF_SkipThrowException };

enum { ftSk_MF_SpecialHi =
    ftSk_MF_SpecialS | Ft_MF_KeepFastFall | Ft_MF_KeepSfx };

enum { ftSk_MF_SpecialAirS =
    ftSk_MF_SpecialS | Ft_MF_SkipParasol };

enum { ftSk_MF_SpecialAirLw =
    ftSk_MF_SpecialLw | Ft_MF_SkipParasol };

enum { ftSk_MF_SpecialAirN =
    ftSk_MF_SpecialN | Ft_MF_SkipParasol };

enum { ftSk_MF_SpecialAirHi =
    ftSk_MF_SpecialHi | Ft_MF_SkipParasol };

enum { ftSk_MF_SpecialSLoop = ftSk_MF_SpecialS | Ft_MF_Unk19 };

enum { ftSk_MF_SpecialNLoop = ftSk_MF_SpecialN | Ft_MF_Unk19 };

enum { ftSk_MF_SpecialAirSLoop =
    ftSk_MF_SpecialSLoop | Ft_MF_SkipParasol };

enum { ftSk_MF_SpecialAirNLoop =
