 ...
 * melee/ft/forward.h. */
enum { ftCommon_GroundAirColl_MF =
...
enum { ftCo_MF_OttottoWait = Ft_MF_Unk19 | Ft_MF_SkipMetalB };
enum { ftCo_MF_CliffAction =
    Ft_MF_UnkUpdatePhys | Ft_MF_SkipMetalB };
enum { ftCo_MF_CliffAction_4_5 =
    ftCo_MF_CliffAction | Ft_MF_SkipModel | Ft_MF_SkipAnimVel };
enum { ftCo_MF_CliffCatch =
    ftCo_MF_CliffAction_4_5 | Ft_MF_Unk06 };
enum { ftCo_MF_CliffAttackSlow =
    ftCo_MF_AttackBase | ftCo_MF_CliffAction_4_5 | Ft_MF_KeepGfx |
    Ft_MF_KeepColAnimHitStatus | Ft_MF_SkipHit };
enum { ftCo_MF_CliffWait = ftCo_MF_CliffAction | Ft_MF_Unk19 };
enum { ftCo_MF_CatchWait =
    Ft_MF_FreezeState | Ft_MF_SkipMetalB };
enum { ftCo_MF_CatchBase =
    ftCo_MF_CatchWait | Ft_MF_SkipModel | Ft_MF_SkipAnimVel };
enum { ftCo_MF_Catch =
    ftCo_MF_CatchBase | Ft_MF_KeepFastFall | Ft_MF_KeepGfx };
enum { ftCo_MF_Throw = ftCo_MF_CatchBase | Ft_MF_SkipItemVis };
enum { ftCo_MF_CatchAttack =
    ftCo_MF_Throw | Ft_MF_KeepColAnimHitStatus };
enum { ftCo_MF_ThrowF =
    ftCo_MF_CatchAttack | Ft_MF_KeepFastFall };
enum { ftCo_MF_ThrowB = ftCo_MF_CatchAttack | Ft_MF_KeepGfx };
enum { ftCo_MF_ThrowHi = ftCo_MF_ThrowF | Ft_MF_KeepGfx };
enum { ftCo_MF_ThrowLw = ftCo_MF_Throw | Ft_MF_SkipHit };
enum { ftCo_MF_Capture =
    ftCo_MF_CatchWait | Ft_MF_UnkUpdatePhys };
enum { ftCo_MF_CaptureAir =
    ftCo_MF_Capture | Ft_MF_SkipParasol };
enum { ftCo_MF_Thrown =
    ftCo_MF_Capture | Ft_MF_KeepSwordTrail };
enum { ftCo_MF_ThrownAir =
    ftCo_MF_Thrown | Ft_MF_SkipParasol };
enum { ftCo_MF_Shouldered = ftCo_MF_Capture | Ft_MF_Unk19 };
enum { ftCo_MF_Rebirth =
    Ft_MF_SkipModelPartVis | Ft_MF_SkipMetalB };
enum { ftCo_MF_ThrownStar =
    ftCo_MF_Rebirth | Ft_MF_KeepSwordTrail };
enum { ftCo_MF_Dead = ftCo_MF_Dazed | Ft_MF_SkipMetalB };
enum { ftCo_MF_Sleep = ftCo_MF_Dead | Ft_MF_KeepSwordTrail };
enum { ftCo_MF_Special =
